...
extern double  h2dmc_0 (int nr, double head, int layer);
extern double  t2k_0 (int nr, double wcon, int layer);
extern double  t2h_0 (int nr, double wcon, double depth, int layer);
extern double  h2t_0 (int nr, double head, int layer);
extern double  h2u_0 (int nr, double head, int layer);
extern double  h2k_0 (int nr, double head, int layer);
extern double  h2dkdp_0 (int nr, double head, int layer);
extern double  h2dmc_1 (int nr, double head, int layer);
extern double  t2k_1 (int nr, double wcon, int layer);
extern double  t2h_1 (int nr, double wcon, double depth, int layer);
extern double  h2t_1 (int nr, double head, int layer);
extern double  h2u_1 (int nr, double head, int layer);
extern double  h2k_1 (int nr, double head, int layer);
extern double  h2dkdp_1 (int nr, double head, int layer);
extern double  h2dmc_2 (int nr, double head, int layer);
extern double  t2k_2 (int nr, double wcon, int layer);
extern double  t2h_2 (int nr, double wcon, double depth, int layer);
extern double  h2t_2 (int nr, double head, int layer);
