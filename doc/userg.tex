...
5 & user defined Python functions\\
...
\item[lambda]
Pore-size distribution index $\lambda$ in Brooks and Corey (method~6).
A starting approximation from van Genuchten parameters is $\lambda \approx n - 1$.

\item[hb]
Air-entry (bubbling) pressure head $h_b$ in Brooks and Corey (method~6),
in cm.  Must be negative (e.g.\ \inivar{hb = -16.4}).
A starting approximation from van Genuchten parameters is $h_b \approx -1/\alpha$.
